...
public class HotelResultsPage {
    public static final Target PRICE_RANGE = Target.the("range of price").locatedBy("//a[@id='MainContentPlaceHolder_FilterFormLayout_NightlyRateTrackBar_MD']//a[@id='MainContentPlaceHolder_FilterFormLayout_NightlyRateTrackBar_MD']");
    public static final Target APPLY_FILTER_BUTTON = Target.the("apply filter button").locatedBy("div#MainContentPlaceHolder_FilterFormLayout_ApplyFilterButton_CD");
