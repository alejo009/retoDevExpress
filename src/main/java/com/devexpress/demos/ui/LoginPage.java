...
public class LoginPage {
    ...
    public static final Target FIELD_PASSWORD = Target.the("password field").locatedBy("//input[@id='HeaderControl_LogonControl_LoginFormLayout_txtPassword_I']");
    ...
    public static final Target ERROR_MESSAGE = Target.the("error message").locatedBy("//td[@id='HeaderControl_LogonControl_LoginFormLayout_Captcha_TB_EC']");
}
